...
class DatabaseSeeder extends Seeder
{
    public function run(): void
    {
        ...
        $events = [
            ...
            [
                'title'                 => 'Sự kiện Test Draft (Bản nháp)',
                'description'           => 'Đây là sự kiện đang ở trạng thái Draft để test UI.',
                ...
                'category_id'           => 5,
                'image'                 => null,
                'registration_deadline' => '2026-08-25 23:59:00',
                'created_at'            => now(),
                'updated_at'            => now(),
            ],
            [
                'title'                 => 'Sự kiện Test Published (Đã xuất bản)',
                'description'           => 'Đây là sự kiện đang ở trạng thái Published để test UI.',
                ...
                'category_id'           => 6,
                'image'                 => null,
                'registration_deadline' => '2026-09-05 23:59:00',
                'created_at'            => now(),
                'updated_at'            => now(),
            ],
        ];
